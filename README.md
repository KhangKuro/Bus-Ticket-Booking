...
![Power Pivot Data Model](https://github.com/KhangKuro/Bus-Ticket-Booking/blob/main/Excel.png)
*Description: Power Pivot Data Model for the Bus Ticket Booking data, showing how different tables are connected and interact with each other.*

---

## 🔄 Workflow Overview

![Recommend Flow](https://github.com/KhangKuro/Bus-Ticket-Booking/blob/main/ReFlow.jpg)
*Description: Recommended flow for the overall workflow, detailing the steps from data collection to data visualization.*
...
![Dashoverview Fare](https://github.com/KhangKuro/Bus-Ticket-Booking/blob/main/DashOverview.png)
*Description: Dashboard overview of fares, illustrating the total revenue generated by different routes and bus companies.*

![Dashoverview Booking](https://github.com/KhangKuro/Bus-Ticket-Booking/blob/main/DashOverviewBooking.png)
*Description: Dashboard overview of bookings, showing the total number of bookings and tickets issued.*

![Dashoverview Tooltip](https://github.com/KhangKuro/Bus-Ticket-Booking/blob/main/DashOverviewTooltip.png)
*Description: Tooltip example on the dashboard, providing detailed information when hovering over specific data points.*
...
![Dash Details](https://github.com/KhangKuro/Bus-Ticket-Booking/blob/main/DashDetails.png)
*Description: Detailed dashboard view, showing in-depth metrics and insights about booking patterns.*

![Dash Details Tooltip](https://github.com/KhangKuro/Bus-Ticket-Booking/blob/main/DashDetailsTooltip.png)
*Description: Tooltip example on the detailed dashboard, providing additional context and information.*
...
![Forecast](https://github.com/KhangKuro/Bus-Ticket-Booking/blob/main/Forecast.png)
*Description: Forecasting dashboard, projecting future trends and patterns based on historical data.*
